...
Mahjong
 ...
 This game makes use of the Shapes3D library.
 
 It is possible to create your own Mahjong games and add
 them to this game without having to program.
...
public void keyReleasedINSTRUCTIONS() {
  if (key == ' ') {
    gState = GAMEON;
    showGameCtrls = false;
    initCamera();
...
public void keyReleasedGAMESELECT() {

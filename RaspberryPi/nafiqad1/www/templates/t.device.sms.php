...
{ 
?>
<ion-view view-title="<?php echo __list_receive_sms?>" name="device_sms-tab">
...
<ion-list show-delete="show.del" show-reorder="show.edit">
	...
	<ion-delete-button class="ion-ios-minus-outline balanced" ng-click="del(user.id,user.name,user.phone)"></ion-delete-button>

/*
 ...
 This is UARTtoWiFiBridge sketch simplified by using pfodESP8266BufferedClient
...
// NOTE: MUST call at least one bufferedClient method each loop to push out buffered data after send delay,  bufferedClient.available() and bufferedClient.connected() are always called here each loop
  //check UART for data
  if (Serial.available()) {
...
void closeConnection() {
  ...
  bufferedClient.stop(); // clear client reference from bufferedClient
